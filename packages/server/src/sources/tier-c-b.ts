...
const CONFIGS: SinglePageConfig[] = [
  ...
  },
  {
    ...
    notes:
      ...
      'Chapter Chair Meeting. Eligibility, corrected against the real page: a minimum of TEN ' +
  ...
  },
  {
    ...
    notes:
      ...
      'vTools Student Branch Reporting. Rebate figures ($50/yr under 50 members, $100/yr at ' +
